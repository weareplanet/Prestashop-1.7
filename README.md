...
## To install module manually by dragging up zip file, please download [.zip archive](https://plugin-documentation.weareplanet.com/weareplanet/prestashop-1.7/1.2.47/weareplanet.zip) of module with correct structure required by Prestashop installation.
...
* [English](https://plugin-documentation.weareplanet.com/weareplanet/prestashop-1.7/1.2.47/docs/en/documentation.html)
...
Please see the [license file](https://github.com/weareplanet/prestashop-1.7/blob/1.2.47/LICENSE) for more information.
